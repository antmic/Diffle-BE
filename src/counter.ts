...
const wordCount = 14983;

// let count = 0;
// winningWordsFiles.forEach(value => {
// 	count += value;
// });
// console.log(count);

//sort the map alphabetically with localCompare by key
let sorted = new Map([...winningWordsFiles.entries()].sort((a, b) => a[0].localeCompare(b[0])));
//console.log(sorted);
...
// [[0.9999332576920216,0.9999999999999696],1,'zż.csv'],
// ];
